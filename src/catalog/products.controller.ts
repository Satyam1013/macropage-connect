...
@Controller("projects/:projectId/catalog/products")
export class ProductsController {
  ...
  create(@Request() req: ProjectAuthReq, @Body() dto: CreateProductDto) {
    const tenantId = req.projectId;
  ...
  @Delete(":id")
  @Roles(UserRole.OWNER, UserRole.ADMIN, UserRole.MANAGER)
  delete(@Request() req: ProjectAuthReq, @Param("id") id: string) {
    const tenantId = req.projectId;
